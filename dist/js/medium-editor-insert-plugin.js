...
import { UrlParams } from '../../../../src/httpservice/urlParams';
import { PermissionsService } from '../../../../src/permissionsService/permissions.service';

// var tenantImagesInfo = PermissionsService.getTenantImages();
// if (tenantImagesInfo) {
//     var imagePath = tenantImagesInfo.imagesUri;
// }
...
(function (factory) {
    ...
    ; (function ($, window, document, Util, undefined) {
        ...
        Images.prototype.uploadDone = function (e, data) {
            ...
            $.proxy(this, 'showImage', imagePath + UrlParams.embeddedView + data.result.relativeUri, data)();
